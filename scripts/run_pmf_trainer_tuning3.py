...
trainer = PMFTrainer3(n_users=n_users, n_items=n_items, n_factors=256, lr=0.001, reg=0.1, epochs=30)
q_i = trainer.load_item_factors(
    encoded_amazon_vectors_path="./data/scaled_encoded_amazon_vectors.csv",
...
trainer.save_user_factors("./data/user_factors(newTuned_targetStd01).npy")
trainer.plot_losses("./data/img/loss_plot(newTuned_targetStd01).png")
trainer.predict_all(val_df, q_i, output_path="./data/output/prediction2(newTuned_targetStd01).csv")